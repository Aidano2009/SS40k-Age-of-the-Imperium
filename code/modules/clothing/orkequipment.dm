...
/obj/item/clothing/gloves/ork //Parent of the children afterwards, inherits from these paths.
    icon = 'icons/obj/clothing/orkgearOBJ.dmi' //Object Icon Path, what appears when dropped.
...
/obj/item/clothing/head/ork
    icon = 'icons/obj/clothing/orkgearOBJ.dmi'
...
/obj/item/weapon/storage/belt/ork/basicbelt/stikkbombs/New()
	..()
//One day this is where the grenades will be.
...
/*
    Back Items
                */
/obj/item/weapon/storage/backpack/ork/burnapack
    name = "Burna Pack"
    desc = "Let forth your passion in a gout of flames."
    icon_state = "orkburnapack"
    item_state = "orkburnapack"
/obj/item/weapon/storage/backpack/ork/jumppack
    name = "Jumppack"
